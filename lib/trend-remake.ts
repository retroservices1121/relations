...
export function trendPrompt() {
  return `FULL CARTOON CHARACTER REPLACEMENT. Image 1 is Joe and Image 2 is Danda. Video 1 is the motion, timing, staging and camera reference.
Replace the complete person on the LEFT in Video 1 with the exact full-body 2D cartoon Joe from Image 1. Replace the complete person on the RIGHT in Video 1 with the exact full-body 2D cartoon Danda from Image 2. The replacements include head, hair, face, neck, torso, arms, hands, legs, feet and clothing. Never leave any live-action human body part visible.
