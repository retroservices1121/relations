...
export default async function Studio(){
  ...
  return <main>
    <header><div><span className="eyebrow">JOE + DANDA</span><h1>Relations Studio</h1><p>Cartoon-first short-form relationship video production.</p></div><div style={{display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}><Link href="/" className="statusPill">← Landing Page</Link><Link href="/music" className="statusPill">♪ Music Studio</Link><div className="statusPill">Studio V1</div></div></header>
